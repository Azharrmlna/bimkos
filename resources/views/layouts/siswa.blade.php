...
<head>
    ...
    <title>@yield('title', 'Dashboard Siswa') - Bimbingan Konseling</title>
...
<body class="bg-gray-100">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <aside id="sidebar" class="sidebar-transition sidebar-expanded fixed inset-y-0 left-0 z-50 bg-gradient-to-b from-green-700 to-green-800 text-white transform lg:translate-x-0 lg:static">
            <!-- Logo -->
            <div class="flex items-center justify-between h-16 px-6 bg-green-800">
                <div class="flex items-center overflow-hidden">
                    ...
                    <span id="logo-text" class="font-bold text-lg ml-3 whitespace-nowrap">Siswa BK</span>
                </div>
            ...
            <div class="hidden lg:flex items-center justify-center py-2 border-b border-green-600">
                <button id="toggle-collapse" class="text-white hover:bg-green-600 p-2 rounded-lg transition">
                    <i id="collapse-icon" class="fas fa-chevron-left"></i>
                </button>
            </div>

            <!-- User Info -->
            <div id="user-info" class="px-6 py-4 border-b border-green-600">
                <div class="flex items-center">
                    ...
                    <div class="ml-3 overflow-hidden sidebar-text">
                        ...
                        <p class="text-sm text-green-200">Siswa</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="px-4 py-6 space-y-2 overflow-y-auto" style="max-height: calc(100vh - 240px);">
                <a href="{{ route('siswa.dashboard') }}" 
                   class="flex items-center px-4 py-3 rounded-lg hover:bg-green-600 transition @if(request()->routeIs('siswa.dashboard')) bg-green-600 @endif"
                   title="Dashboard">
                ...
                <a href="{{ route('siswa.konseling.index') }}" 
                   class="flex items-center px-4 py-3 rounded-lg hover:bg-green-600 transition @if(request()->routeIs('siswa.konseling.*')) bg-green-600 @endif"
                   title="Konseling Saya">
                    <i class="fas fa-clipboard-list w-6 flex-shrink-0"></i>
                    <span class="ml-3 sidebar-text whitespace-nowrap">Konseling Saya</span>
                </a>

                <a href="{{ route('siswa.messages.index') }}" 
                   class="flex items-center px-4 py-3 rounded-lg hover:bg-green-600 transition relative @if(request()->routeIs('siswa.messages.*')) bg-green-600 @endif"
                   title="Pesan">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <button class="relative text-gray-600 hover:text-gray-900">
                                ...
                                @php
                                    $totalNotif = \App\Models\Message::where('receiver_id', auth()->id())->unread()->count();
                                @endphp
                                @if($totalNotif > 0)
